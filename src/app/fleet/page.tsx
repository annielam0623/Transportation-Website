    ...
    <main>
      ...
      <section className="bg-[#04080F] px-6 md:px-20 pt-20 pb-12 border-b border-white/5">
        ...
        <p className="text-white/55 text-base font-light max-w-xl">
          From executive sprinters to full-size coaches — every vehicle is commercially 
          licensed, DOT-compliant, and maintained to the highest standard.
        </p>
      </section>
      ...
      <section className="bg-[#0A428C] px-6 md:px-20 py-16 text-center">
        <h2 className="font-serif text-3xl font-bold mb-3">Need Help Choosing?</h2>
        <p className="text-white/70 mb-7 max-w-lg mx-auto">
          Tell us your group size, route, and date — we'll recommend the right vehicle and send you a quote within 2 hours.
        </p>
        <a href="/booking" className="inline-block bg-white text-brand-blue font-semibold text-sm tracking-widest uppercase px-8 py-3 hover:bg-brand-silver transition-colors">
          Get a Free Quote →
        </a>
      </section>
    </main>
