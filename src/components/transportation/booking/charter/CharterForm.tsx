...
export default function CharterForm() {
  ...
  return (
    <div className="w-full">
      {/* ── Trip Type Tabs ── */}
      <div className="flex items-center gap-8 border-b border-white/10 pt-5">
        <button
          onClick={() => setTripType("single")}
          className={`pb-3 text-[10px] tracking-widest uppercase transition-colors relative ${
            tripType === "single"
              ? "text-white after:absolute after:bottom-[-0.5px] after:left-0 after:right-0 after:h-px after:bg-white"
        ...
        <button
          onClick={() => router.push("/charter/multi-day")}
          className="pb-3 text-[10px] tracking-widest uppercase transition-colors text-white/40 hover:text-white/60 outline-none"
        >
          Multi-Day Itinerary
        </button>
      </div>
      ...
      {/* ── Single Service Form ── */}
      <div className="pt-8">
        {/* Row 1: City / Service Type / Airport Type / Pick-up / Drop-off */}
        <div
          style={{
            display: "grid",
            gridTemplateColumns:
        ...
        {/* Row 2: Date / Time / Pax / Luggage / Submit */}
        <div className="grid grid-cols-[1fr_2fr_1fr_1fr_auto] lg:grid-cols-[1fr_1fr_1fr_1fr_auto] gap-0 pt-8 items-end">
          {/* Date */}
          <div className="pr-10 border-r border-white/10">
            <p className="text-[10px] tracking-widest text-white/40 uppercase mb-1.5">
              Date
            ...
            <input
              ...
              className="w-full bg-transparent border-b border-white/20 text-sm text-white outline-none py-1.5 cursor-pointer"
            />
          </div>
          ...
          <div className="pl-10 max-lg:hidden">
            <button
              ...
              className="px-8 py-2.5 text-xs tracking-[0.2em] uppercase bg-[#6A7A8C] text-white hover:bg-[#7A8A9C] transition-all duration-200 disabled:bg-[#2A3A4C] disabled:text-white/60 disabled:cursor-not-allowed"
            >
        ...
        <div className="hidden max-lg:flex justify-center mt-6">
          <button
            ...
            className="w-1/2 py-2.5 text-xs tracking-[0.2em] uppercase bg-[#6A7A8C] text-white hover:bg-[#7A8A9C] transition-all duration-200 disabled:bg-[#2A3A4C] disabled:text-white/60 disabled:cursor-not-allowed"
          >
            Check Vehicles & Price
          </button>
        </div>
